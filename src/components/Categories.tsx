...
const categories = [
  {
    ...
    description: 'Artificial intelligence powered solutions for automation and insights',
  },
  {
    name: 'Business Tools',
    icon: (
    ...
    description: 'Essential tools for modern businesses and entrepreneurs',
  },
  {
    ...
    description: 'Boost efficiency with smart productivity applications',
  },
  {
    name: 'Education',
    icon: (
    ...
    description: 'Learning platforms for knowledge seekers',
  },
  {
    name: 'Utilities',
    icon: (
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-dark-200 text-lg max-w-2xl mx-auto">
            Explore our diverse range of software solutions across multiple domains
          </p>
        </motion.div>
        ...
        >
          {categories.map((category) => (
            ...
            >
              {/* Icon */}
              <div className={`w-16 h-16 rounded-xl bg-gradient-to-br ${category.gradient} flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform duration-300`}>
                {category.icon}
              </div>

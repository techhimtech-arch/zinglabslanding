...
const contactMethods = [
  {
    name: 'Email',
    value: 'hello@zinglabs.dev',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
      </svg>
    ),
    href: 'mailto:hello@zinglabs.dev',
  ...
  },
  {
    ...
    href: 'https://linkedin.com/company/zinglabs',
  ...
  },
  {
    ...
    href: 'https://github.com/zinglabs',
        ...
        >
          {contactMethods.map((method, index) => (
            ...
            >
              ...
              {/* Name */}
              <h3 className="text-white font-semibold mb-1 group-hover:text-accent-400 transition-colors">
                {method.name}
              </h3>
        ...
        >
          <div className="glass rounded-2xl p-8 max-w-2xl mx-auto">
            ...
            <p className="text-dark-300 mb-6">
              We are always looking for new challenges and opportunities to build something amazing.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.98 }}
              className="px-8 py-4 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl text-white font-semibold hover:shadow-lg hover:shadow-indigo-500/25 transition-all"
            >
              Schedule a Call
            </motion.button>
          </div>
